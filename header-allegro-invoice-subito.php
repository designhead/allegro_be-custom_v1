...
<head profile="http://gmpg.org/xfn/11">
	...
	<link type="text/css" rel="Stylesheet" href="<?php bloginfo('template_directory'); ?>/styles/bjqs.css" />
...
<?php if($page_id=="607" || $page_id=="119" || $page_id=="310" || $page_id=="722") {?>
	...
	<div class="bg">
		<img src="<?php echo get_stylesheet_directory_uri() ?>/img/allegro-invoice-subito.jpg">
	</div>
