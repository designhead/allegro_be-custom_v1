		...
		<div class="col1">
			<form>
             <h2 style="margin-bottom:3px">Filter By Country</h2>
								          ...
								          <input id=" country-Belgium " value="Belgium " type="checkbox" name="country-Belgium ">Belgium  <br>
                                          <input id=" country-Czech" value="Czech" type="checkbox" name="country-Czech">Czech <br>
              ...
              <h2 style="margin-bottom:3px">Filter By Region</h2>
								          ...
								          <input id=" Luxembourg" value="Luxembourg" type="checkbox" name="region-Luxembourg">Luxembourg <br>
                                          <input id=" Antwerpen" value="Antwerpen" type="checkbox" name="region-Antwerpen">Antwerpen <br>
                                          
                                              <input id=" Wallonie" value="Wallonie" type="checkbox" name="region-Wallonie">Wallonie <br>
